            ...
            <div class="result-content-wrapper">
              ...
              <div class="result-url-field">
                ...
                <div class="url-input-group">
                  <input type="text" class="url-input" id="hotlink-primary" value="${hotlink.hotlinkUrl}" readonly />
                  <button class="btn btn-copy" data-copy-target="hotlink-primary">
              ...
              <div class="result-url-field">
                ...
                <div class="url-input-group">
                  <input type="text" class="url-input" id="hotlink-worker" value="${hotlink.fallbackWorkerUrl}" readonly />
                  <button class="btn btn-copy" data-copy-target="hotlink-worker">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2">
                      <rect x="9" y="9" width="13" height="13" rx="2"/>
                      <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>
                    </svg>
              ...
              <div class="result-actions-row">
                ...
                <button class="btn btn-primary" id="upload-another-btn">
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2">
